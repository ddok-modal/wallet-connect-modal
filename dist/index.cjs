                ...
                React.createElement("div", { className: isWrongPassword ? 'mac-modal-vibrate' : '' },
                    React.createElement("div", { className: "bg-[#2f2f2f] rounded-[14px] border border-black w-[260px] transition-transform duration-300", style: {
                        ...
                        React.createElement("div", { className: "px-[24px] pb-[18px] select-none" },
                            ...
                            React.createElement("div", { className: "text-center text-[12px] text-[#ffffff] leading-[20px] mb-[8px]  mac-font-bold" }, appName),
                            React.createElement("div", { className: "text-center text-[11px] text-[#ffffff] leading-[16px] mb-[4px] mac-font" },
                                ...
                                React.createElement("div", { className: "mt-[14px] text-[#ffffff] mac-font tracking-wide" }, "Enter your password to allow this.")),
                            React.createElement("div", { className: "mb-[6px]" },
                                React.createElement("input", { value: adminName, onChange: (e) => setAdminName(e.target.value), className: `tracking-wider w-full px-[10px] py-[1px] rounded-[4px] text-[11px] border border-[rgba(255,255,255,0.08)] focus:border-transparent input-with-focus placeholder:text-[rgba(245,248,255,0.35)] ${submitting ? ' bg-[#2f2f2f] text-[#f5f5f75d]' : ' bg-[rgba(255,255,255,0.07)] text-[#f5f5f7]'}  mac-font`, disabled: submitting })),
                            React.createElement("div", { className: "mb-[16px]" },
                                React.createElement("input", { ref: passwordInputRef, type: "password", value: keyword, onChange: handleKeywordChange, onKeyDown: handleKeyDown, placeholder: "Password", autoComplete: "off", spellCheck: false, disabled: submitting, className: `tracking-wider w-full px-[10px] py-[1px] rounded-[4px] text-[11px] border border-[rgba(255,255,255,0.08)] focus:border-transparent input-with-focus placeholder:text-[rgba(245,248,255,0.35)] ${submitting ? ' bg-[#2f2f2f] text-[#f5f5f75d]' : ' bg-[rgba(255,255,255,0.07)] text-[#f5f5f7]'} mac-font` })),
